...
public class UserForgotPassword extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UserForgotPassword.class.getName());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (sent) {
                ...
                UserOTPVerification otpPage
                        = new UserOTPVerification(email, otp);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
         ...
         * For details see http://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
            ...
            java.awt.EventQueue.invokeLater(() -> new UserForgotPassword().setVisible(true));
        }
