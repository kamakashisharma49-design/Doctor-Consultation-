 ...
 * @author
 */
public class GeneralPhysician extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GeneralPhysician.class.getName());
...
// ==========================================
    ...
    private void initComponents() {
        ...
        jLabel5.setText("General Physicians");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(320, 20, 340, 50);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel8.setText("Find the best general physician for your care.");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(320, 70, 330, 19);
...
// ==========================================
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GeneralPhysician().setVisible(true));
    }
