...
public class Cardiologist extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Cardiologist.class.getName());
...
// ==========================================
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Cardiologists");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(330, 20, 250, 50);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel8.setText("Find the best cardiologist for your care.");
        jPanel1.add(jLabel8);
...
// ==========================================
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Cardiologist().setVisible(true));
    }
