 ...
 * @author
 */
public class Orthopedic extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Orthopedic.class.getName());
...
// ==========================================
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Orthopedics");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(330, 20, 250, 50);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel8.setText("Find the best orthopedic for your care.");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(320, 70, 280, 19);
...
// ==========================================
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Orthopedic().setVisible(true));
    }
