 ...
 *
 */
public class UserOTPVerification extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UserOTPVerification.class.getName());

    public UserOTPVerification(String email, String otp) {
        initComponents();
        // Store email and OTP
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (enteredOTP.equals(generatedOTP)) {
            ...
            UserResetPassword resetPage
                    = new UserResetPassword(userEmail);
