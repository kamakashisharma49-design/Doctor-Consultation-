...
public class UserResetPassword extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UserResetPassword.class.getName());
    private static final long serialVersionUID = 1L;

    /**
     * Creates new form UserHomePage
     */
    public UserResetPassword(String email) {
        initComponents();
        setSize(1150, 720);
